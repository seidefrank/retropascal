...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"ReTro_Pascal.DisplaySettings")
    {
    ...
    if (typeName == L"ReTro_Pascal.MainPage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::ReTro_Pascal::MainPage(); 
            };
        return userType;
    }

    if (typeName == L"ReTro_Pascal.SettingsAbout")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.UserControl"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::ReTro_Pascal::SettingsAbout(); 
            };
        return userType;
    }
