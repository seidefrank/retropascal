...
#include "App.g.hpp"
#include "DisplaySettings.g.hpp"
#include "MainPage.g.hpp"
#include "SettingsAbout.g.hpp"
...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"WinRT_First_Steps.DisplaySettings")
    {
    ...
    if (typeName == L"WinRT_First_Steps.MainPage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::WinRT_First_Steps::MainPage(); 
            };
        return userType;
    }

    if (typeName == L"WinRT_First_Steps.SettingsAbout")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.UserControl"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::WinRT_First_Steps::SettingsAbout(); 
            };
        return userType;
    }
